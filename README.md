...
# System Architecture
1.The system follows a client–server architecture:
2.User uploads dataset via web interface
3.Gradio frontend sends data to backend
4.Data preprocessing and cleaning performed
5.Parallel processing applied for faster computation
6.Machine Learning and Deep Learning models executed
7.Peak detection and recommendation system applied
...
# Author
Madugula Sai Pallavi B.Tech CSE (Data Science)SR University
